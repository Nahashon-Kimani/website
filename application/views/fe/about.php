			...
			<div class="col-md-4">
				<div class="counter-box">
					...
					<p class="text-justify text-white">Enhancing the 
						...
						and Development to deliver market-defining high-quality 
						solutions that create value and reliable competitive 
						advantage for our clients around the world.</p>
				</div>
			</div>
			<!-- Vision -->
			<div class="col-md-4">
				<div class="counter-box">
					...
					<p class="text-center text-white">To deliver market-defining 
						...
						competitive advantage for our clients around the world.</p>
				</div>
			</div>
			<!-- Our Drive -->
			<div class="col-md-4">
...
<div class="faq content-area-7">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-5">
				<img src="<?php echo base_url(); ?>assets/img/managment-img-2.jpg" 
					alt="Core Values"
...
<div class="faq content-area-7">
    <div class="container">
        <div class="main-title">
            ...
            <p>We promise to deliver the best</p>
		</div>
...
<hr class="tall"> <!-- This class adds more space with a line in between -->
