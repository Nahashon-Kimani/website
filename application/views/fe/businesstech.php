...
<div class="sub-banner overview-bgi">
    <div class="container">
        <div class="breadcrumb-area">
            <h1 class="display-3">BUSINESS SOLUTIONS</h1>
            <ul class="breadcrumbs">
                <li><a href="home"><i class="fa fa-home" aria-hidden="true"></i> Home</a></li>
                <li class="active">Business Technology</li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="managment-info">
                    <h1><span>Business</span> Technologies Categories</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-title">
                    <h1><span>About </span>our Solutions </h1>
                </div>
            </div>
        </div>
<!-- Accordion -->
