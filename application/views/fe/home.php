    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo base_url(); ?>assets/img/banner-1.jpg" alt="banner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url(); ?>assets/img/banner-3.jpg" alt="banner">
                <div class="carousel-caption banner-slider-inner d-flex h-100">
                    <div class="carousel-content container">
                        <div class="text-c">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                <div class="intro-text text-center">
                    <h3 class="text-white font-weight-bold">Welcome to My Testing Website</h3>
					<p class="font-italic text-white">The middleware to reliability.</p>
                </div>
            </div>
			<div class="col-xl-2 col-lg-2 col-md-2 col-sm-12">
            ...
            <div class="col-lg-6 col-md-7 offset-lg-1">
                <div class="managment-slider">
                    <div id="carouselExampleIndicators-managment" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>assets/img/managment-img-1.jpg" alt="First slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>assets/img/managment-img-2.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                                <img class="d-block w-100 img-fluid" src="<?php echo base_url(); ?>assets/img/managment-img-3.jpg" alt="Third slide">
                            </div>
                        </div>
                        <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
...
<!-- Earned trust of many -->
	<!-- Our recent Projects Heading Ends -->
		<div class="services content-area-2 bg-grea">
			<div class="container">
				<div class="main-title">
    ...
    <div class="row">
        <div class="multi-carousel" data-items="1,3,5,6" data-slide="1" id="multiCarousel"  data-interval="1000">
            <div class="multi-carousel-inner">
                ...
                <div class="item">
                    <div class="pad15">
                        <img src="<?php echo base_url();?>assets/img/brands/brand-2.png" alt="brand">
                    </div>
				</div>
				<div class="item">
                    <div class="pad15">
                ...
                <div class="item">
                    <div class="pad15">
                        <img src="<?php echo base_url();?>assets/img/brands/brand-3.png" alt="brand">
                    </div>
                </div>
                <div class="item">
                    <div class="pad15">
