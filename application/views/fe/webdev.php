            ...
            <div class="col-md-7">
                <div class="managment-info">
                    ...
                    <p class="text-justify">People search online then buy locally. 
                        ...
                        ocean in which all enterprices (both online and offline) 
                        must either sink or swim</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="managment-info">
                    <h1><span>Our</span> Website Categories</h1>
                </div>
            </div>
        </div>
